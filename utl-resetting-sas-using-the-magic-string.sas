Resetting sas using the magic string
...
execute the magic string in one movement. Drag over string and tap RMB(submit).
I often tap the RMB multiple times, especially if the log screen indicated the first tap
